...
const Counter = (props) => {
  ...
  /*
    ...
    useEffect guarantees that it will not be fired if dependencies have not changed. 
    useMemo does not give such guarantees.
    ...
    You could just think of useMemo as another assignment statement with benefits to
    use the assignment from last update.
  ...
  }, [latestInputValue]); /// when passed as normal fun it creates a new fun everytime and renders the components.
  ...
  return (
    <>
      ...
      <div style={{ border: "1px solid", margin: 10 }}>
        ...
        <Button variant="outlined" style={btnStyle} onClick={handleIncrement}>
          Increment
        </Button>
